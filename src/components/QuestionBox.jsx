    ...
    return (
        <div className="bg-white p-8 mx-auto w-96 rounded rounded-xl relative">
            ...
            {quizBank.map(({ id, question, answers, correct }) => (
                <div key={id}>
                    <p className="font-bold text-gray-700 text-lg lg:text-xl mb-5">{question}</p>
            ...
            <div className='flex justify-end'>
                <button
                    ...
                    className='text-gray-700  border border-gray-700 rounded py-2 px-3 hover:text-white hover:bg-orange-400 hover:border-orange-400 disabled:opacity-25 disabled:cursor-not-allowed'>
                    Next
                </button>
            </div>
        </div>
